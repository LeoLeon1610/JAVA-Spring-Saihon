...
//	public static String secret = "LaCH41#PareceMuda$DespuésDeLaSemana10.YElAbandonoDeAMY$";
	public static String secret = "LaCH41#PareceMuda$DespuesDeLaSemana10.YElAbandonoDeAMY$";
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
		...
		if (  (("POST".equals(httpServletRequest.getMethod())) && 
				...
				( ("GET".equals(httpServletRequest.getMethod())) && 
						(! httpServletRequest.getRequestURI().contains("/api/libros/") )  ) ||
